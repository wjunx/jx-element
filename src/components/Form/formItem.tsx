...
export const FormItem: FC<FormItemProps> = (props) => {
  ...
  const rowClass = classNames('jx-row', {
    'jx-row-no-label': !label
  })
  useEffect(() => {
  ...
  const labelClass = classNames({
    'jx-form-item-required': isRequired
  })
  const itemClass = classNames('jx-form-item-control', {
    'jx-form-item-has-error': hasError
  })
  ...
  return (
    <div className={rowClass}>
      { label &&
        <div className='jx-form-item-label'>
          <label title={label} className={labelClass}>
            {label}
          </label>
        </div>
      }
      <div className='jx-form-item'>
        <div className={itemClass}>
          {returnChildNode}
        </div>
        { hasError && 
          <div className='jx-form-item-explain'>
